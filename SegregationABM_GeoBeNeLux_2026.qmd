---
title: "An ABM to investigate the effects of spatio-temporal segregation on health inequalities"
author: "Clémentine Cottineau-Mugadza, Julien Perret, Romain Reuillon, Sébastien Rey-Coyrehourcq & Julie Vallée     BeNeLux Geography Conference 2026"
editor: visual
format: 
  revealjs: 
    theme: moon
...
Segregation and contextual eﬀects differ throughout the day, as people move between locations in a city.

> Eﬀects of spatial segregation on social outcomes need to be studied temporally (“around the clock”).

To understand the eﬀects of spatio-temporal social segregation on the diﬀusion of dietary behaviours, data can become unsufficient.

> Empirical agent-based model initialised on the Paris region.

## Study design

-   (Mobile) **synthetic population** generated from two health & nutrition surveys + French census + origin-destination survey.
...
![](figures/figure1.png){width="100%," fig-align="centre"}
...
[This paper](https://doi.org/10.1140/epjds/s13688-025-00603-4)
![](figures/epj2.png)
...
[This presentation](https://clementinecttn.github.io/GeoBenelux/SegregationABM_GeoBeNeLux_2026)
