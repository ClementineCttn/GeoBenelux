...
In this article, we aim to understand the eﬀects of spatio-temporal social segregation on the diﬀusion of dietary behaviours, using an empirical agent-based model initialised on the Paris region.
...
This presentation: ![](figures/epj2.png)
